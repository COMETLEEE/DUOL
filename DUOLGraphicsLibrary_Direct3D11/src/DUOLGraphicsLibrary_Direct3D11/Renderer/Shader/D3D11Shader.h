...
namespace DUOLGraphicsLibrary
{
    ...
    private:
        ...
        bool BuildGeometryShaderAtrribute(ID3D11Device* device, ComPtr<ID3D11ShaderReflection> ShaderReflector, std::vector<D3D11_SO_DECLARATION_ENTRY>& outputElements);
