...
namespace DUOLGame
{
	...
	void CometTestScene::Awake()
	{
		...
		boxObject->AddComponent<DUOLGameEngine::MeshFilter>()->
			SetMesh(DUOLGameEngine::ResourceManager::GetInstance()->GetMeshByID(TEXT("Joy")));

		boxObject->AddComponent<DUOLGameEngine::MeshRenderer>();

		boxObject->GetComponent<DUOLGameEngine::MeshRenderer>()->SetMaterial(_T("Boy01_Scarf_MAT"));
		boxObject->GetComponent<DUOLGameEngine::MeshRenderer>()->SetMaterial(_T("Boy01_LowerBody_MAT"));
		boxObject->GetComponent<DUOLGameEngine::MeshRenderer>()->SetMaterial(_T("Boy01_Hair_MAT"));
		boxObject->GetComponent<DUOLGameEngine::MeshRenderer>()->SetMaterial(_T("Boy01_Shoes_MAT"));
		boxObject->GetComponent<DUOLGameEngine::MeshRenderer>()->SetMaterial(_T("Boy01_UpperBody_MAT"));
		boxObject->GetComponent<DUOLGameEngine::MeshRenderer>()->SetMaterial(_T("Boy01_Hands_MAT"));
		boxObject->GetComponent<DUOLGameEngine::MeshRenderer>()->SetMaterial(_T("Boy01_Head_MAT"));
