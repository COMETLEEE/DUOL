...
DUOLGame::ThirdPersonCamera::~ThirdPersonCamera()
{
}

void DUOLGame::ThirdPersonCamera::SetTargetObject(DUOLGameEngine::GameObject* targetObject)
{
	_targetObject = targetObject;
}

DUOLMath::Vector3 DUOLGame::ThirdPersonCamera::CalcRotation(const DUOLMath::Vector3& lookVec)
{
...
void DUOLGame::ThirdPersonCamera::OnAwake()
{
	DUOLGameEngine::Transform* transform = GetTransform();
	//transform->SetParent(_targetObject->GetTransform());
}

void DUOLGame::ThirdPersonCamera::OnStart()
{
}

void DUOLGame::ThirdPersonCamera::OnDestroy()
{
}

void DUOLGame::ThirdPersonCamera::OnUpdate(float deltaTime)
{
...
void DUOLGame::ThirdPersonCamera::OnLateUpdate(float deltaTime)
{
