...
#pragma region WINDOW_INITIALIZE
		...
		engineSpec._screenWidth = SCREEN_WIDTH;

		engineSpec._screenHeight = SCREEN_HEIGHT;

		engineSpec._startSceneName = DUOLCommon::StringHelper::ToTString("Editor");
		...
		RECT rect{ 100, 100,
			100 + engineSpec._screenWidth, 100 + engineSpec._screenHeight };
...
#pragma region LOAD_자체포맷_SCENE_SERIALIZED + PROTOTYPING
		...
		//auto scene = DUOLGameEngine::SceneManager::GetInstance()->LoadSceneFileFrom(TEXT("Asset/Scene/ActionTest.dscene"));
#pragma endregion
