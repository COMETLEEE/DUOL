#include "DUOLEditor/UI/Widgets/Plots/PlotLines.h"

namespace DUOLEditor
{
	PlotLines::PlotLines(const std::vector<float>& data, float minScale, float maxScale,
	...
	{
		ImGui::PlotLines(DUOLCommon::StringHelper::ToString(_label + _tstringID).c_str(), _data.data(), static_cast<int>(_data.size()), 0,
