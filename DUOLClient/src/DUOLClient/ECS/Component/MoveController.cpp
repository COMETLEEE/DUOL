...
RTTR_REGISTRATION
{
	rttr::registration::class_<DUOLClient::MoveController>("MoveController")
	.constructor<DUOLGameEngine::GameObject*, const DUOLCommon::tstring&>()
	(
		rttr::policy::ctor::as_raw_ptr
	)
	.property("MoveSpeed", &DUOLClient::MoveController::GetMoveSpeed, &DUOLClient::MoveController::SetMoveSpeed)
	(
		metadata(DUOLCommon::MetaDataType::Serializable, true)
		, metadata(DUOLCommon::MetaDataType::Inspectable, true)
		, metadata(DUOLCommon::MetaDataType::InspectType, DUOLCommon::InspectType::Float)
	)
	.property("IsWorldMode",&DUOLClient::MoveController::GetIsWorldMode, &DUOLClient::MoveController::SetIsWorldMode)
	(
		metadata(DUOLCommon::MetaDataType::Serializable, true)
		, metadata(DUOLCommon::MetaDataType::Inspectable, true)
