...
{
	DUOLClient::Action_EnemyVoiceSoundPlay::Action_EnemyVoiceSoundPlay(const std::string& name, const BT::NodeConfig& config) :
	...
	BT::NodeStatus DUOLClient::Action_EnemyVoiceSoundPlay::tick()
	{
	...
	BT::PortsList DUOLClient::Action_EnemyVoiceSoundPlay::providedPorts()
	{
		BT::PortsList result = {
