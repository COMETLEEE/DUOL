...
namespace DUOLClient
{
	...
	class Action_EnemySoundPlay : public BT::SyncActionNode
	{
	public:
		Action_EnemySoundPlay(const std::string& name, const BT::NodeConfig& config);

		virtual ~Action_EnemySoundPlay() override = default;
