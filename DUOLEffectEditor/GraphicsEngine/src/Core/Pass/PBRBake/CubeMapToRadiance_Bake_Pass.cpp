...
MuscleGrapics::CubeMapToRadiance_Bake_Pass::CubeMapToRadiance_Bake_Pass() : Pass_Texture(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST)
{
	...
	resoureManager->CompilePixelShader(pipeLineDesc, TEXT("Asset/Particle/Shader/Shader_CubeMapToRadianceMap.hlsl"), "PSMain");
...
void MuscleGrapics::CubeMapToRadiance_Bake_Pass::SetConstants(
...
void MuscleGrapics::CubeMapToRadiance_Bake_Pass::Draw(
	std::vector<std::pair<ID3D11ShaderResourceView*, int>>& renderingData)
{
	SetShader();
