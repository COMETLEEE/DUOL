...
void Inspector::ParticleSystemCommonInfo_StartSize()
{
	...
	if (ImGui::BeginPopup("StartSize_popup"))
	{
		...
		if (ImGui::Selectable("Constant"))
			_myParticle->GetParticleData()->_commonInfo->_startSizeOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::Constant;

		if (ImGui::Selectable("Random Between Two Constants"))
			_myParticle->GetParticleData()->_commonInfo->_startSizeOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::RandomBetweenTwoConstant;
...
void Inspector::ParticleSystemCommonInfo_StartSpeed()
{
	...
	if (ImGui::BeginPopup("StartSpeed_popup"))
	{
		...
		if (ImGui::Selectable("Constant"))
			_myParticle->GetParticleData()->_commonInfo->_startSpeedOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::Constant;

		if (ImGui::Selectable("Random Between Two Constants"))
			_myParticle->GetParticleData()->_commonInfo->_startSpeedOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::RandomBetweenTwoConstant;
...
void Inspector::ParticleSystemCommonInfo_StartLifetime()
{
	...
	if (ImGui::BeginPopup("StartLifeTime_popup"))
	{
		...
		if (ImGui::Selectable("Constant"))
			_myParticle->GetParticleData()->_commonInfo->_startLifeTimeOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::Constant;

		if (ImGui::Selectable("Random Between Two Constants"))
			_myParticle->GetParticleData()->_commonInfo->_startLifeTimeOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::RandomBetweenTwoConstant;
...
void Inspector::ParticleSystemCommonInfo_StartRotation()
{
	...
	if (ImGui::BeginPopup("StartRotation_popup"))
	{
		...
		if (ImGui::Selectable("Constant"))
			_myParticle->GetParticleData()->_commonInfo->_startRotationOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::Constant;

		if (ImGui::Selectable("Random Between Two Constants"))
			_myParticle->GetParticleData()->_commonInfo->_startRotationOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::RandomBetweenTwoConstant;
...
void Inspector::ParticleSystemCommonInfo_StartColor()
{
	...
	if (ImGui::BeginPopup("StartColor_popup"))
	{
		...
		if (ImGui::Selectable("Constant"))
			_myParticle->GetParticleData()->_commonInfo->_startColorOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::Constant;

		if (ImGui::Selectable("Random Between Two Constants"))
			_myParticle->GetParticleData()->_commonInfo->_startColorOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::RandomBetweenTwoConstant;
...
void Inspector::ParticleSystemCommonInfo_GravityModifier()
{
	...
	if (ImGui::BeginPopup("GravityModifier_popup"))
	{
		...
		if (ImGui::Selectable("Constant"))
			_myParticle->GetParticleData()->_commonInfo->_gravirtModifierOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::Constant;

		if (ImGui::Selectable("Random Between Two Constants"))
			_myParticle->GetParticleData()->_commonInfo->_gravirtModifierOption = MuscleGrapics::Particle_CommonInfo::Option_Particle::RandomBetweenTwoConstant;
